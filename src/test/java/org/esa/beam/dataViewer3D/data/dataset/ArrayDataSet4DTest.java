...
public class ArrayDataSet4DTest
{
    ...
    public void testGetBuilder()
    {
        ...
        assertNotNull(ArrayDataSet4D.getBuilder(1L));
        assertNotNull(ArrayDataSet4D.getBuilder(1000000L));
        assertNotNull(ArrayDataSet4D.getBuilder(null, 1));
        assertNotNull(ArrayDataSet4D.getBuilder(null, 100));
        assertNotNull(ArrayDataSet4D.getBuilder(1L, 1));
        assertNotNull(ArrayDataSet4D.getBuilder(100L, 1));
        assertNotNull(ArrayDataSet4D.getBuilder(1L, 100));
        assertNotNull(ArrayDataSet4D.getBuilder(100L, 100));

        try {
            ArrayDataSet4D.getBuilder(0L);
            fail("Managed to get a builder for data set of target size 0.");
        } catch (IllegalArgumentException e) {}

        try {
            ArrayDataSet4D.getBuilder(0L, 0);
            fail("Managed to get a builder for data set of target size 0.");
        } catch (IllegalArgumentException e) {}

        try {
            ArrayDataSet4D.getBuilder(0L, 10);
            fail("Managed to get a builder for data set of target size 0.");
        } catch (IllegalArgumentException e) {}

        try {
            ArrayDataSet4D.getBuilder(10L, 0);
            fail("Managed to get a builder for data set of target size 0.");
        } catch (IllegalArgumentException e) {}
        ...
        try {
            ArrayDataSet4D.getBuilder(-1L);
            fail("Managed to get a builder for data set of negative target size.");
        } catch (IllegalArgumentException e) {}

        try {
            ArrayDataSet4D.getBuilder(-1L, 0);
            fail("Managed to get a builder for data set of negative target size.");
        } catch (IllegalArgumentException e) {}

        try {
            ArrayDataSet4D.getBuilder(-1L, 1);
            fail("Managed to get a builder for data set of negative target size.");
        } catch (IllegalArgumentException e) {}
        ...
        try {
            ArrayDataSet4D.getBuilder(10L, -1);
            fail("Managed to get a builder for data set of negative target size.");
        } catch (IllegalArgumentException e) {}
    ...
    {
        DataSet4D<Byte, Integer, Double, Float> dataSet = ArrayDataSet.createFromDataSources(null,
        ...
        dataSet = ArrayDataSet.createFromDataSources(null, getTestDataSourceX(120000), getTestDataSourceY(120000),
                getTestDataSourceZ(120000), getTestDataSourceW(120000));
