 ...
 * 
 */
package org.esa.beam.dataViewer3D.data.axis.tickgenerator._double;
...
public class TickCountTickGenerator extends
        org.esa.beam.dataViewer3D.data.axis.tickgenerator.TickCountTickGenerator<Double>
{
    ...
    protected void computeTicks()
    {
        ...
        double difference = max - min; // ok, max is always bigger
